...
class ExternalDeliveryPartnerSeeder extends Seeder
{
    ...
    public function run()
    {
        $delivery_partners = array(
            array('code' => 'VIN', 'name' => 'VINSTRAN', 'api_url' => 'http://api.vintrans.com.vn:8989/api/customer/trackinglading', 'api_method' => 'GET', 'api_key' => '', 'api_secret' => '', 'api_body_datas' => '"{     \\"Username\\":\\"SGN0450BTN\\",     \\"Password\\":\\"vts@2022\\"}"', 'api_delivery_code_field' => 'Code', 'is_external' => '1', 'is_active' => '1', 'created_at' => '2023-09-26 12:45:26', 'updated_at' => '2023-09-26 12:45:26', 'deleted_at' => NULL),
            array('code' => 'NET', 'name' => 'NETCO', 'api_url' => 'https://api-v4-erp.vps.vn/api/V1Customer/APIC_spLadingGet', 'api_method' => 'GET', 'api_key' => '', 'api_secret' => '', 'api_body_datas' => '"{   \\"CustomerCode\\": \\"SGN14174SGN\\",   \\"AppAPIKey\\": \\"0UtiJ3ZNav5HPf2jzdby4A==\\" }"', 'api_delivery_code_field' => 'LadingCode', 'is_external' => '1', 'is_active' => '1', 'created_at' => '2023-09-26 15:55:26', 'updated_at' => '2023-09-26 16:17:51', 'deleted_at' => NULL)
        );
