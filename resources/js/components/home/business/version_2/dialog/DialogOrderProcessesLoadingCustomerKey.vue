<template>
    <div>
        <div class="modal fade" id="DialogOrderProcessesLoadingCustomerKey" data-backdrop="static" data-keyboard="false"
            tabindex="-1">
...
export default {
    ...
    methods: {
        hideModal() {
            $('#DialogOrderProcessesLoadingCustomerKey').modal('hide');
        },
        showModal() {
            $('#DialogOrderProcessesLoadingCustomerKey').modal('show');
        }
    },
    computed: {
