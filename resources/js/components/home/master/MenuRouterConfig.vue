                    ...
                    <div class="card-body">
                        <div class="row mt-1">
                            ...
                            <div class="col-md-4">
                                <div class="row mt-1">
                                    <div
                                        class="input-group input-group-sm col-12"
                                    >
                        ...
                        <div class="row">
                            ...
                            >
                                <div slot-scope="slotProps">
                                    <template
                                        v-if="!slotProps.data.isDragPlaceHolder"
                                    >
                                        <i
            ...
            if (menu) {
                ...
                if (childs_id && childs_id.length > 0) {
                    ...
                    childs_id.forEach((child_menu_id) => {
                        let nested_childrens_id =
                            this.tree_menus[child_menu_id];
