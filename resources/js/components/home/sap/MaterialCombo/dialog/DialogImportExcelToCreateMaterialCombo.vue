<template>
	<div
		class="modal fade"
		id="DialogImportExcelToCreateMaterialCombo"
		tabindex="-1"
		role="dialog"
	...
	>
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<form @submit.prevent="createNewMaterialCombo">
...
<script>
	...
	export default {
		name: 'DialogImportExcelToCreateMaterialCombo',
		components: {
			Vue,
			Treeselect,
			TextInputSearch,
		...
		methods: {
			async createNewMaterialCombo() {
				try {
					...
					const { data } = await this.api_handler
						...
						.post(
							'/api/master/material-combos/excel',
							{},
			...
			closeDialog() {
				this.resetForm();
				this.resetDialog();
				$('#DialogImportExcelToCreateMaterialCombo').modal('hide');
			},
